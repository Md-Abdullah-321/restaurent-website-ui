    ...
    <div className="container mx-auto my-10">
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-10 md:h-[420px]">
        ...
        <div className="w-full md:w-6/12 p-4 sm:p-0">
          ...
          {/* Price */}
          <p className="text-2xl font-semibold text-gray-800 mt-4">${item.price.toFixed(2)}</p>

          {/* Description */}
          <p className="text-gray-600 mt-3">{item.description}</p>

          {/* Add to Cart Button */}
          <Button className="mt-5 w-full bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg">
            Add to Cart
          </Button>
